  ...
  return {
    "Cmaj": {
      ...
      "syntonic": [
        ...
        ['redSyntonic'], ['D', 'syntonic'], [purple], ['purple'], [highlight, 'none', 'none', highlight]],
      "common": [
        [4], ["Cmaj6"], [orange, orange, orange, orange],
        ["sharp9", "sharp11", "M6", "root"], [yellow, yellow, orange, orange],
        ['yellowCommon'], ['T', 'common'], [orange], ['orange'], ['none', 'none', highlight, highlight]
      ],
    ...
    "Ebmin": {
      ...
      "syntonic": [
        [4], ["Ebmin"], [orange, orange, orange, orange],
        ["b11", "P5", "b7", "b9"], [red, orange, orange, red],
        ['redSyntonic'], ['D'], [purple], ['purple'], ['none', highlight, highlight, 'none']],
      "common": [
        [4], ["Ebmin"], [orange, orange, orange, orange],
